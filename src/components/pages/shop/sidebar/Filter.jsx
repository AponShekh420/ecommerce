      ...
      <p className="text-lg font-semibold uppercase">filter by price</p>
        <div className="flex flex-col gap-2 w-full h-full max-w-md items-start justify-center">
          ...
          <div className="flex justify-between w-full items-center mt-1 md:gap-x-2">
            <button className="text-white bg-BtnBg lg:py-2 lg:px-3 md:px-2 md:py-1 rounded-md font-semibold text-xs shadow-md shadow-slate-700 uppercase border-btnColor border-[2px]">Filter</button>
