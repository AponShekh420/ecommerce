  ...
  return (
    <div>
      ...
      <p className="text-center text-[#333333] text-[16px] mb-3">
        Ohel Miriam was created to address knowledge gaps on the Torah
        perspective of marital harmony, intimate relationship and related
        topics.
      </p>
      <p className="text-center text-[#333333] text-[16px] mb-3">
        Ohel Miriam arranges live teleconferences and courses, catering to both
        men and women alike. These sessions feature insights from Rabbonim,
        women lecturers, therapists, and medical professionals.
      </p>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 text-center sm:justify-center">
        <div className="flex items-center flex-col">
          ...
          <p className="text-[18px] font-[600] text-customColor text-center">
            Couples
          </p>
