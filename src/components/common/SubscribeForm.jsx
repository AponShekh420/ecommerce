  ...
  return (
    <div className="w-full">
      <Form {...form} className="w-full">
        <form onSubmit={form.handleSubmit(onSubmit)} className="gap-y-4 flex w-full flex-wrap">
          <FormField
          ...
          <FormField 
            ...
            render={({ field }) => (
              <FormItem className="sm:w-1/2 w-full sm:pr-3 space-y-1">
                <FormLabel>Spouse Name <span className="text-red-600">*</span></FormLabel>
                <FormControl>
          ...
          <FormField 
            ...
            render={({ field }) => (
              <FormItem className="sm:w-1/2 w-full sm:pr-3 space-y-1">
                <FormLabel>Zip <span className="text-red-600">*</span></FormLabel>
                <FormControl>
        ...
        />
          <Button type="submit" className="bg-BtnBg py-2 text-center px-3 rounded-3xl font-semibold text-xs shadow-md shadow-slate-700 uppercase border-btnColor border-[2px] mt-1 text-white m-auto">Submit</Button>
        </form>
      </Form>
    </div>
  )
